...
$.extend(DayGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		if (!event.allDay && seg.isStart) {
			timeHtml = '<span class="fc-time">' + htmlEscape(view.getEventTimeText(event)) + 'm - </span>';
		}
...
$.extend(BasicView.prototype, {
	...
	dayGrid: null, // the aula_virtual subcomponent that does most of the heavy lifting
...
$.extend(AgendaView.prototype, {
	...
	timeGrid: null, // the aula_virtual time-grid subcomponent of this view
